...
export function PreviewPane() {
  ...
  return (
    <section className="rounded-[1.75rem] border border-slate-200 bg-white/85 p-4 shadow-xl shadow-blue-100/40 backdrop-blur-sm">
      <div className="mb-4 flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-3 py-2">
        <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">
          Column 2 · Draft Staging Preview
        </p>
      ...
      <div className="flex justify-center">
        <div
          className={`min-h-[640px] rounded-2xl border border-slate-200 bg-[linear-gradient(180deg,_#ffffff,_#f8fafc)] p-6 shadow-inner transition-all duration-300 ${deviceClasses[activeDevice]}`}
        >
          {jsonError && (
